    ...
    for e2efs_class in e2efs_classes:
        ...
        for j, (train_index, test_index) in enumerate(rskf.split(raw_data, raw_label)):
            ...
            for i, n_features in enumerate([5, 10, 15, 20]):
                ...
                n_real_feats.append((best_features < redundancy_1.REAL_FEATURES).sum())
                n_redundant_feats.append((best_features < (redundancy_1.REAL_FEATURES + redundancy_1.REDUNDANT_FEATURES)).sum() - n_real_feats[-1])
