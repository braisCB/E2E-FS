...
data_filename = 'lung.mat'

def load_dataset(directory=None):
    directory = (os.path.dirname(os.path.realpath(__file__)) + '/../datasets' if directory is None else directory) + '/lung181/'
...
def load_data(directory):
    ...
    with open(directory + data_filename) as f:
        ...
        info['raw']['label'] = np.asarray(mat['labels']).astype(int).T
