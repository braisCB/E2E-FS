function [RANKED, WEIGHT] = infFS_fast( X_train, Y_train, alpha, supervision,loading, verbose, filename )
% [RANKED, WEIGHT ] = infFS_fast( X_train, Y_train, alpha, supervision,loading, verbose, filename ) computes ranks and weights
